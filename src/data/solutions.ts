    ...
    products: [
      {
        ...
        description:
          'The web application and its backend-for-frontend: the governed definition inventory, framework adoption, artifact generation, and appraisal dashboards — one place where the IT landscape is defined, governed, and visualized.',
        features: [
          ...
          { slug: 'framework-adoption', name: 'Framework adoption', blurb: 'Attach TOGAF, ISO 25010 / 25012, GDPR, NIS2, DORA and more from the catalogue — their governance is enforceable in your model on day one.' },
          ...
          { slug: 'appraisal', name: 'Appraisal dashboards', blurb: 'Continuous governance indicators — measures and findings computed from the model, so coverage and conformance are observed, not reconstructed before each audit.' },
        ],
      ...
      {
        slug: 'sourcer',
        name: 'Repository Sourcer',
        tagline: 'Truth sourcing — the model reflects reality, continuously.',
        description:
          'The sourcing pipeline that reads real IT artifacts — source code, API contracts, infrastructure — and posts them as evidence-backed contributions to the SIE Blackboard, so the definition stays anchored to the real system instead of drifting from it.',
        features: [
          ...
          { slug: 'contribution-flow', name: 'Blackboard contribution flow', blurb: 'Contributions post to the SIE Blackboard, are validated, sealed byte-stable, and promoted into governed definitions with the audit trail intact.' },
        ],
      ...
      {
        slug: 'frameworks',
        name: 'Frameworks Catalogue',
        tagline: 'Established bodies of knowledge, sourced into GSM — ready to enforce.',
        description:
          'The published, versioned catalogue of governance, compliance, architecture, and regulatory frameworks sourced into GSM-compatible schemas — ready-made Archetypes, Directives, and Norms you attach instead of authoring from scratch.',
        features: [
  ...
  },
  {
    ...
    products: [
      ...
      },
      {
        ...
        description:
          'The Blackboard is a collaborative definition-sourcing service: contributors post evidence-backed contributions over declared panels, the board is sealed to a byte-stable state, and every mutation lands in an append-only audit ledger.',
        features: [
        ...
        docs: [{ href: 'https://docs.poesis.cloud/sie-blackboard/', label: 'SIE Blackboard documentation' }],
        repos: [
