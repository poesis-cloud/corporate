...
```mermaid
flowchart LR
    I[Governing intent<br/>Directives] --> N[Operationalized governance<br/>Norms]
    N --> D[Governed operative definitions<br/>Ascriptions]
    D --> R[Realization and operation]
    R --> O[Description and evidence]
    O --> C[Conformance and appraisal]
    C -->|adapt governance| I
    C -->|revise criteria| N
    C -->|revise definitions| D
    C -->|correct realization| R
```
